...
plt.xlabel('')
plt.ylabel('')
plt.title('Quantidade de Inscritos por Cor/Raça',
          fontdict = param_titulo)
...
plt.title('Quantidade de Treineiros por Município',
          fontdict = param_titulo)

treineiros_count.plot(column = 'Treineiros', cmap = 'GnBu', legend = True, edgecolor= 'gray',  ax=ax,
                       missing_kwds={ "color": '#f5f2f2',
                                      'alpha': 0.5,
                                      "label": "Sem dados" },
                       legend_kwds={'shrink': 0.6, 'aspect': 30})
...
ax[0, 0].set_xlabel('')
ax[0, 0].set_ylabel('')
ax[0, 0].set_title('Quantidade de Inscritos por Cor/Raça', fontdict = param_titulo)
ax[0, 0].grid(False)
...
ax[0, 1].set_title('Distribuição por Faixa Etária',
                  fontdict = param_titulo)
